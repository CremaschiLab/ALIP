...
d50(r,s)$(ord(r)>=2)..LFR(r,s) =l= 520*1.296*sum((i,p)$(ord(i) ne 7),y(i,p,s)*Qgbar(i,s))*(1+b*D*(rr(r)-1))**(-1/b);
d51(r,s)$(ord(r)>=2)..Qg(r,s) =l= 800*1.296*sum((i,p)$(ord(i) ne 7),y(i,p,s)*Qgbar(i,s))*(1+b*D*(rr(r)-1))**(-1/b);
d52(r,s)$(ord(r)>=2)..Qo(r,s) =l= 20*1.296*sum((i,p)$(ord(i) ne 7),y(i,p,s)*Qgbar(i,s))*(1+b*D*(rr(r)-1))**(-1/b);
d53(r,s)$(ord(r)>=2)..Qng(r,s) =l= 500*1.296*sum((i,p)$(ord(i) ne 7),y(i,p,s)*Qgbar(i,s))*(1+b*D*(rr(r)-1))**(-1/b);
