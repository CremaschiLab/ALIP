...
c41(r,t), c43(p), c44(p), c45(p), c46(p), c47(p),c49(r,t)
...
b5(t,r),  b7(t,r),
b9(p), b10(p), b11(t,r), b12(p), b13(p,r), b14(t,r), b15(t,r),
e1(i,t,p,j,k,l),
f1, f2, f3, f4,
...
b9(p)$(Packer = 1 and ord(p)>=2)..y('2',p)*1.2*FLP - CITHP =l= 0;
b10(p)$(Packer = 0 and ord(p)>=2)..y('2',p)*2.5*FLP - CITHP =l= 0;
...
$offtext
** method 5
c33(r,t)$(ord(t)>=ord(r)).. LFR(r) - 150*z('5',t) =g= 0;
c34(p).. CGA - y('5',p) =g= 0;
...
c41(r,t)$(ord(t)>=ord(r)).. z('6',t)*10 - LFR(r) =l= 0;
...
*** gai
c49(r,t)$(ord(t)>=ord(r)).. z('7',t)*10 - LFR(r) =l= 0;
*** gai
...
b14(t,r)$(WellDepth <= 6000  and ord(t)>=ord(r))..z('8',t)*10 - LFR(r) =l= 0;
b15(t,r)$(WellDepth >= 6000  and ord(t)>=ord(r))..z('8',t)*60 - LFR(r) =l= 0;


** method 9
c62(p).. y('9',p) * DLS - 24 =l= 0;
c63(p).. y('9',p)*WellDepth - 15000 =l= 0;
c64(r,t)$(ord(t)>=ord(r)).. z('9',t)*200 - LFR(r) =l= 0;
...
d50(r)$(ord(r)>=2)..LFR(r) =l= 520*1.08*(1+b*D*(rr(r)-1))**(-1/b);
d51(r)$(ord(r)>=2)..Qg(r) =l= 800*1.08*(1+b*D*(rr(r)-1))**(-1/b);
d52(r)$(ord(r)>=2)..Qo(r) =l= 20*1.08*(1+b*D*(rr(r)-1))**(-1/b);
d53(r)$(ord(r)>=2)..Qng(r) =l= 500*1.08*(1+b*D*(rr(r)-1))**(-1/b);
